...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="admin/css/sweetalert.css">
  <link rel="stylesheet" type="text/css" href="admin/admin/css/datatables.min.css">
  <link rel="stylesheet" type="text/css" href="admin/css/modules/animations-extended.min.css">
  <link rel="stylesheet" type="text/css" href="admin/css/print.css" media="print">
  <link rel="stylesheet" type="text/css" href="admin/css/tagify.css">
...
<body class="bg-light">
	<div class="container justify-content-center align-items-center">
		<div class="py-5">
            ...
            @endif
					    <form action="{{ url('/login') }}" method="post" class="text-center needs-validation" style="color: #757575;" novalidate>
								@csrf
					      <div class="md-form">
        ...
        <script type="text/javascript" src="admin/js/sweetalert-dev.js"></script>
        <script type="text/javascript" src="admin/js/jquery.PrintArea.js"></script>
