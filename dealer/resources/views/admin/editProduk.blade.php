        ...
        <div class="card">
          <div class="card-body">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <a href="{{ url('/produk') }}" class="btn btn-info">Tabel Produk</a>
            ...
            <form action="" class="range-field" method="post" enctype="multipart/form-data">
              @csrf
              <div class="md-form">
                <input type="text" id="nama" name="nama_produk" class="form-control" value="{{$edit->nama_produk}}" required>
                <label for="nama">Nama Produk</label>
              </div>
              <div class="md-form">
                <input type="text" id="jenis" name="jenis_produk" class="form-control" value="{{$edit->jenis_produk}}" required>
                <label for="jenis">Jenis Produk</label>
              </div>
              <div class="md-form">
                <input type="text" id="spek" name="spek" class="form-control" value="{{$edit->spek}}" required>
                <label for="spek">Spesifikasi Produk</label>
              </div>
              <label>Foto</label>
              <small>* Kosongkan Jika Tidak ingin Ganti Foto</small>
              <div class="md-form">
                <input type="file" name="foto1" class="form-control" onchange="tampilkanPreview(this,'liat1')">
                <input type="file" name="foto2" class="form-control" onchange="tampilkanPreview(this,'liat2')">
                <input type="file" name="foto3" class="form-control" onchange="tampilkanPreview(this,'liat3')">
              </div>
