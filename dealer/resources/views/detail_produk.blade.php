      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category1599"> <a href="/home" title="">Produk</a> <span>&rsaquo; </span> </li>
            <li class="category1600"> <a href="/detail_produk" title="">Detail Produk</a> <span>&rsaquo; </span> </li>
          </ul>
        </div>
        <!--col-xs-12--> 
      </div>
      ...
      <div class="col-main"> 
        ...
        <div class="product-view wow bounceInUp animated" itemscope="" itemtype="http://schema.org/Product" itemid="#product_base">
            ...
            <div class="row">
                ...
                <div class="product-img-box col-lg-5 col-sm-5 col-xs-12">
                  <div class="product-image">
                    <div class="product-full"> <img id="product-zoom1" src="{{url('user/products-images/p46.jpg')}}" data-zoom-image="{{url('user/products-images/p46.jpg')}}" alt="product-image"/> </div>
                  </div>
                  <!-- end: more-images --> 
                </div>
                <!--End For version 1,2,6--> 
                ...
                <div class="product-shop col-lg- col-sm-7 col-xs-12">
                  ...
                  <h2 style="background-color: #CD5C5C; color: white">Specifications</h2>
                    <table width="100%">
                      <tbody>
                        <tr>
          ...
          <div class="product-collateral container">
            ...
            <div id="reviews_tabs" class="tab-content">
