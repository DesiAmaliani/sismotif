          ...
          <div id="thmg-slideshow" class="thmg-slideshow">
            <div id='rev_slider_4_wrapper' class='rev_slider_wrapper fullwidthbanner-container' >
              <div id='rev_slider_4' class='rev_slider fullwidthabanner'>
                <ul>
                  <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='images/4439.jpg'><img src="{{url('user/images/4439.jpg')}}"  data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner"/>
                    <div class="container">
                  ...
                  <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='images/motor.jpg'><img src="{{url('user/images/motor.jpg')}}"  data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner"/>
                    <div class="container">
                      <div class="content_slideshow">
                        <div class="row">
                          <div>
        ...
        <div class="slider-items slider-width-col4 products-grid">
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="/detail_produk" title="Retis lapen casen" class="product-image"><img src="{{url('user/products-images/p13.jpg')}}" alt="Retis lapen casen"></a>
                  <div class="new-label new-top-left">New</div>
                  <div class="item-box-hover">
                    <div class="box-inner">
                      
                      <div class="product-detail-bnt"><a class="button detail-bnt" href="/detail_produk"><span>Quick View</span></a></div>
                    </div>
                  </div>
                </div>
              </div>
              <div class="item-info">
                <div class="info-inner">
                  <div class="item-title"><a href="/detail_produk" title="Retis lapen casen">Gorgeous Mercedes-Benz E-Class All-Terrain Luxury</a> </div>
          ...
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="/detail_produk" title="Retis lapen casen" class="product-image"><img src="{{url('user/products-images/p14.jpg')}}" alt="Retis lapen casen"></a>
                  <div class="new-label new-top-left">New</div>
                  <div class="item-box-hover">
                    <div class="box-inner">
          ...
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"> <a href="/detail_produk" title="Retis lapen casen" class="product-image"><img src="{{url('user/products-images/p15.jpg')}}" alt="Retis lapen casen"></a>
                  <div class="new-label new-top-left">New</div>
                  <div class="item-box-hover">
                    <div class="box-inner">
          ...
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="/detail_produk" title="Retis lapen casen" class="product-image"><img src="{{url('user/products-images/p16.jpg')}}" alt="Retis lapen casen"></a>
                  <div class="new-label new-top-left">New</div>
                  <div class="item-box-hover">
                    <div class="box-inner">
          ...
          <div class="item">
            <div class="item-inner">
              <div class="item-img">
                <div class="item-img-info"><a href="/detail_produk" title="Retis lapen casen" class="product-image"><img src="{{url('user/products-images/p17.jpg')}}" alt="Retis lapen casen"></a>
                  <div class="new-label new-top-left">New</div>
                  <div class="item-box-hover">
                    <div class="box-inner">
