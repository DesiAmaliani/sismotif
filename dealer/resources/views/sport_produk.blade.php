      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category1599"> <a href="/sport_produk" title="">Produk</a> <span>&rsaquo; </span> </li>
            <li class="category1599"> <a href="/sport_produk" title="">Sport</a> <span>&rsaquo; </span> </li>
          </ul>
        </div>
        <!--col-xs-12--> 
      </div>
    ...
    <div class="row">
            ...
            <ul class="products-grid">
              <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
               <div class="item-inner">
                <div class="item-img">
                  <div class="item-img-info"><a href="/detail_produk" title="Retis lapen casen" class="product-image"><img src="{{url('user/products-images/p1.jpg')}}" alt="Retis lapen casen"></a>
              ...
              <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                <div class="item-inner">
                <div class="item-img">
                  <div class="item-img-info"><a href="/detail_produk" title="Retis lapen casen" class="product-image"><img src="{{url('user/products-images/p2.jpg')}}" alt="Retis lapen casen"></a>
                    <div class="item-box-hover">
                      <div class="box-inner">
                        <div class="product-detail-bnt"><a class="button detail-bnt" href="/detail_produk"><span>Quick View</span></a></div>
                      </div>
      ...
      <aside class="col-left sidebar col-sm-3 col-xs-12 col-sm-pull-9 wow bounceInUp animated"> 
        <div class="block block-compare">
          <div><a class="block-title" href="/produk"> All Products</a></div>
         <div class="block-content">
            <ol id="compare-items">
            <li class="item odd">
                <a class="product-name" href="/matic_produk">Matic</a></li>
             <li class="item odd">
                <a class="product-name" href="/sport_produk">Sport</a></li>
